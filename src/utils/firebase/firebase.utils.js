...
// additionalInformation parameter is used to overwrite null displayName from firebase response.user object with displayName from sign-up form, if sign-up method uses email and password
